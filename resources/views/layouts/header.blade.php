	...
	<link rel="apple-touch-icon" href="<?=url('/')?>/public/pages/ico/60.png">
	<link rel="apple-touch-icon" sizes="76x76" href="<?=url('/')?>/public/pages/ico/76.png">
	<link rel="apple-touch-icon" sizes="120x120" href="<?=url('/')?>/public/pages/ico/120.png">
	<link rel="apple-touch-icon" sizes="152x152" href="<?=url('/')?>/public/pages/ico/152.png">
	...
	<link href="<?=url('/')?>/public/assets/plugins/bootstrap/css/bootstrap.min.css" rel="stylesheet" type="text/css" />
	<link href="<?=url('/')?>/public/assets/plugins/font-awesome/css/font-awesome.css" rel="stylesheet" type="text/css" />
	<link href="<?=url('/')?>/public/assets/plugins/jquery-scrollbar/jquery.scrollbar.css" rel="stylesheet" type="text/css" media="screen" />
	<link href="<?=url('/')?>/public/assets/plugins/select2/css/select2.min.css" rel="stylesheet" type="text/css" media="screen" />
	<link href="<?=url('/')?>/public/assets/plugins/switchery/css/switchery.min.css" rel="stylesheet" type="text/css" media="screen" />
	<link href="<?=url('/')?>/public/assets/plugins/bootstrap3-wysihtml5/bootstrap3-wysihtml5.min.css" rel="stylesheet" type="text/css" />
	<link href="<?=url('/')?>/public/assets/plugins/bootstrap-tag/bootstrap-tagsinput.css" rel="stylesheet" type="text/css" />
	<link href="<?=url('/')?>/public/assets/plugins/dropzone/css/dropzone.css" rel="stylesheet" type="text/css" />
	<link href="<?=url('/')?>/public/assets/plugins/bootstrap-datepicker/css/datepicker3.css" rel="stylesheet" type="text/css" media="screen">
	<link href="<?=url('/')?>/public/assets/plugins/summernote/css/summernote.css" rel="stylesheet" type="text/css" media="screen">
	...
	<script src="<?=url('/')?>/public/assets/plugins/jquery-ios-list/jquery.ioslist.min.js" type="text/javascript"></script>
