									...
									<div class="notification-item unread clearfix">
										<div class="heading">
											<div class="thumbnail-wrapper d24 circular b-white m-r-5 b-a b-white m-t-10 m-r-10">
												<img width="30" height="30" data-src-retina="<?=url('/')?>/public/assets/img/profiles/1x.jpg" data-src="<?=url('/')?>/public/assets/img/profiles/1.jpg" alt="" src="<?=url('/')?>/public/assets/img/profiles/1.jpg">
											</div>
											<a href="#" class="text-complete pull-left">
		...
		<div class="user-container d-flex align-items-center">
			...
			<div class="pull-left d-lg-block">
				...
				<ul class="d-lg-inline-block d-none notification-list no-margin d-lg-inline-block b-grey b-l b-r no-style p-l-30 p-r-20 search-btn" style="margin-right:20px !important">
					...
					<li class="p-r-10 inline">
						<a class="btn-link header-icon pg pg-search btn-with-act" data-act="search_client_form"> </a>
					</li>
				</ul>
			</div>
			...
			<div class="dropdown pull-right d-lg-block d-none">
				...
				<div class="dropdown-menu dropdown-menu-right profile-dropdown" role="menu">
					<a href="{{url("/")}}/manage_account" class="dropdown-item"><i class="pg-settings_small"></i> Settings</a>
